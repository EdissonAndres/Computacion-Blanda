# Comentado por Edisson Montes, Alejandro Rios
#!/usr/bin/env python
# coding: utf-8
...
# se grafican simultaneamente los modelos de grado 1,2,3,10,53
# sin limites((proyeccion)), en la ruta y con el nombre indicado
...
# de inflexión
# -----------------------------------------------------------------
#calcula el punto de inflexion en la semana 3.5
inflexion = 3.5 * 7 * 24
...
# limites(con proyeccion a futuro) especificamente hasta la semana 6
...
# especificamente hasta la semana 6, en la ruta y con el nombre de archivo indicado
plot_models(
...
# precisamente hasta la semana 6,con la ruta y el nombre de archivo indicado  
plot_models(
...
# nota2= se divide el resultado obtenido en horas de la semana (7*24)
# para obtener el resultado dado en semanas
